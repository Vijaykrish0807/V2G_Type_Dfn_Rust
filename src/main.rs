...
/**
  ...
  **/
  ...
  pub enum ISO2generatedFunctionNumbersType{
      ISO2AC_EVChargeParameter = 0,
      ISO2AC_EVSEChargeParameter = 1,
      ISO2AC_EVSEStatus = 2,
      ISO2AuthorizationReq = 3,
      ISO2AuthorizationRes = 4,
      ISO2BodyElement = 5,
      ISO2CableCheckReq = 6,
      ISO2CableCheckRes = 7,
      ISO2CanonicalizationMethod = 8,
      ISO2CertificateInstallationReq = 9,
      ISO2CertificateInstallationRes = 10,
      ISO2CertificateUpdateReq = 11,
      ISO2CertificateUpdateRes = 12,
      ISO2ChargeParameterDiscoveryReq = 13,
      ISO2ChargeParameterDiscoveryRes = 14,
      ISO2ChargingStatusReq = 15,
      ISO2ChargingStatusRes = 16,
      ISO2CurrentDemandReq = 17,
      ISO2CurrentDemandRes = 18,
      ISO2DC_EVChargeParameter = 19,
      ISO2DC_EVPowerDeliveryParameter = 20,
      ISO2DC_EVSEChargeParameter = 21,
      ISO2DC_EVSEStatus = 22,
      ISO2DC_EVStatus = 23,
      ISO2DSAKeyValue = 24,
      ISO2DigestMethod = 25,
      ISO2DigestValue = 26,
      ISO2EVChargeParameter = 27,
      ISO2EVPowerDeliveryParameter = 28,
      ISO2EVSEChargeParameter = 29,
      ISO2EVSEStatus = 30,
      ISO2EVStatus = 31,
      ISO2Entry = 32,
      ISO2KeyInfo = 33,
      ...
      ISO2KeyValue = 35,
      ISO2Manifest = 36,
      ISO2MeteringReceiptReq = 37,
      ISO2MeteringReceiptRes = 38,
      ISO2MgmtData = 39,
      ISO2Object = 40,
      ISO2PGPData = 41,
      ISO2PMaxScheduleEntry = 42,
      ISO2PaymentDetailsReq = 43,
      ISO2PaymentDetailsRes = 44,
      ISO2PaymentServiceSelectionReq = 45,
      ISO2PaymentServiceSelectionRes = 46,
      ISO2PowerDeliveryReq = 47,
      ISO2PowerDeliveryRes = 48,
      ISO2PreChargeReq = 49,
      ISO2PreChargeRes = 50,
      ISO2RSAKeyValue = 51,
      ISO2Reference = 52,
      ISO2RelativeTimeInterval = 53,
      ISO2RetrievalMethod = 54,
      ISO2SAScheduleList = 55,
      ISO2SASchedules = 56,
      ISO2SPKIData = 57,
      ISO2SalesTariffEntry = 58,
      ISO2ServiceDetailReq = 59,
      ISO2ServiceDetailRes = 60,
      ISO2ServiceDiscoveryReq = 61,
      ISO2ServiceDiscoveryRes = 62,
      ISO2SessionSetupReq = 63,
      ISO2SessionSetupRes = 64,
      ISO2SessionStopReq = 65,
      ISO2SessionStopRes = 66,
      ISO2Signature = 67,
      ISO2SignatureMethod = 68,
      ISO2SignatureProperties = 69,
      ISO2SignatureProperty = 70,
      ISO2SignatureValue = 71,
      ISO2SignedInfo = 72,
      ISO2TimeInterval = 73,
      ISO2Transform = 74,
      ISO2Transforms = 75,
      ISO2V2G_Message = 76,
      ISO2WeldingDetectionReq = 77,
      ISO2WeldingDetectionRes = 78,
      ISO2X509Data = 79
  }
  ...
  pub enum ISO2EnergyTransferModeType{
      ISO2EnergyTransferModeType_AC_single_phase_core = 0,
      ISO2EnergyTransferModeType_AC_three_phase_core = 1,
      ISO2EnergyTransferModeType_DC_core = 2,
      ISO2EnergyTransferModeType_DC_extended = 3,
      ISO2EnergyTransferModeType_DC_combo_core = 4,
      ISO2EnergyTransferModeType_DC_unique = 5
  }
  ...
  pub enum ISO2faultCodeType{
      ISO2faultCodeType_ParsingError = 0,
      ISO2faultCodeType_NoTLSRootCertificatAvailable = 1,
      ISO2faultCodeType_UnknownError = 2
  }
  ...
  pub enum ISO2DC_EVErrorCodeType{
      ISO2DC_EVErrorCodeType_NO_ERROR = 0,
      ISO2DC_EVErrorCodeType_FAILED_RESSTemperatureInhibit = 1,
      ISO2DC_EVErrorCodeType_FAILED_EVShiftPosition = 2,
      ISO2DC_EVErrorCodeType_FAILED_ChargerConnectorLockFault = 3,
      ISO2DC_EVErrorCodeType_FAILED_EVRESSMalfunction = 4,
      ISO2DC_EVErrorCodeType_FAILED_ChargingCurrentdifferential = 5,
      ISO2DC_EVErrorCodeType_FAILED_ChargingVoltageOutOfRange = 6,
      ISO2DC_EVErrorCodeType_Reserved_A = 7,
      ISO2DC_EVErrorCodeType_Reserved_B = 8,
      ISO2DC_EVErrorCodeType_Reserved_C = 9,
      ISO2DC_EVErrorCodeType_FAILED_ChargingSystemIncompatibility = 10,
      ISO2DC_EVErrorCodeType_NoData = 11
  }
  ...
  pub enum ISO2EVSENotificationType{
      ISO2EVSENotificationType_None = 0,
      ISO2EVSENotificationType_StopCharging = 1,
      ISO2EVSENotificationType_ReNegotiation = 2
  }
  ...
  pub enum ISO2unitSymbolType{
      ISO2unitSymbolType_h = 0,
      ISO2unitSymbolType_m = 1,
      ISO2unitSymbolType_s = 2,
      ISO2unitSymbolType_A = 3,
      ISO2unitSymbolType_V = 4,
      ISO2unitSymbolType_W = 5,
      ISO2unitSymbolType_Wh = 6
  }
  ...
  pub enum ISO2isolationLevelType{
      ISO2isolationLevelType_Invalid = 0,
      ISO2isolationLevelType_Valid = 1,
      ISO2isolationLevelType_Warning = 2,
      ISO2isolationLevelType_Fault = 3,
      ISO2isolationLevelType_No_IMD = 4
  }
  ...
  pub enum ISO2DC_EVSEStatusCodeType{
      ISO2DC_EVSEStatusCodeType_EVSE_NotReady = 0,
      ISO2DC_EVSEStatusCodeType_EVSE_Ready = 1,
      ISO2DC_EVSEStatusCodeType_EVSE_Shutdown = 2,
      ISO2DC_EVSEStatusCodeType_EVSE_UtilityInterruptEvent = 3,
      ISO2DC_EVSEStatusCodeType_EVSE_IsolationMonitoringActive = 4,
      ISO2DC_EVSEStatusCodeType_EVSE_EmergencyShutdown = 5,
      ISO2DC_EVSEStatusCodeType_EVSE_Malfunction = 6,
      ISO2DC_EVSEStatusCodeType_Reserved_8 = 7,
      ISO2DC_EVSEStatusCodeType_Reserved_9 = 8,
      ISO2DC_EVSEStatusCodeType_Reserved_A = 9,
      ISO2DC_EVSEStatusCodeType_Reserved_B = 10,
      ISO2DC_EVSEStatusCodeType_Reserved_C = 11
  }
  ...
  pub enum ISO2responseCodeType{
      ...
      ISO2responseCodeType_FAILED = 4,
      ISO2responseCodeType_FAILED_SequenceError = 5,
      ISO2responseCodeType_FAILED_ServiceIDInvalid = 6,
      ISO2responseCodeType_FAILED_UnknownSession = 7,
      ISO2responseCodeType_FAILED_ServiceSelectionInvalid = 8,
      ISO2responseCodeType_FAILED_PaymentSelectionInvalid = 9,
      ISO2responseCodeType_FAILED_CertificateExpired = 10,
      ISO2responseCodeType_FAILED_SignatureError = 11,
      ISO2responseCodeType_FAILED_NoCertificateAvailable = 12,
      ISO2responseCodeType_FAILED_CertChainError = 13,
      ISO2responseCodeType_FAILED_ChallengeInvalid = 14,
      ISO2responseCodeType_FAILED_ContractCanceled = 15,
      ISO2responseCodeType_FAILED_WrongChargeParameter = 16,
      ISO2responseCodeType_FAILED_PowerDeliveryNotApplied = 17,
      ISO2responseCodeType_FAILED_TariffSelectionInvalid = 18,
      ISO2responseCodeType_FAILED_ChargingProfileInvalid = 19,
      ISO2responseCodeType_FAILED_MeteringSignatureNotValid = 20,
      ISO2responseCodeType_FAILED_NoChargeServiceSelected = 21,
      ISO2responseCodeType_FAILED_WrongEnergyTransferMode = 22,
      ISO2responseCodeType_FAILED_ContactorError = 23,
      ISO2responseCodeType_FAILED_CertificateNotAllowedAtThisEVSE = 24,
      ISO2responseCodeType_FAILED_CertificateRevoked = 25
  }
